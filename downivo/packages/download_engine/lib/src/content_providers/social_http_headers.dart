...
class SocialHttpHeaders {
  ...
  /// Instagram's logged-out GraphQL query is a desktop web document.
  /// Android Chrome receives a media-less mobile shell.
  static const instagramDesktopUserAgent =
