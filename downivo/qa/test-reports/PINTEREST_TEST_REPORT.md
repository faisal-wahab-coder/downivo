...
Pinterest support is **implemented and tested** in the Downivo download engine. Before this phase the platform was declared (`SocialPlatform.pinterest`, `pin.it` host, generic OG video regex) but **had no resolver**, no pin identity, and no image/video/Idea Pin extraction.
