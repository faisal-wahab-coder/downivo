...
Vimeo support is **implemented and tested** in the Downivo download engine. Before this phase Vimeo was **not a platform**: `SocialPlatform.fromUri` returned null for `vimeo.com`, there was no resolver, and YouTube URL tests used Vimeo as a negative example.
