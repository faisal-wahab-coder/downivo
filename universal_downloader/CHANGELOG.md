...
All notable changes to Universal Downloader are documented here.
...
- Save to Gallery for photos and videos (Files actions, file details, completed downloads). Copies into the system gallery album `Universal Downloader`; originals stay in the app library.
